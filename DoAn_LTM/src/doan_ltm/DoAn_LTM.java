...
public class DoAn_LTM {
    ...
    static int port = 1234;//khai bao port su dung
    ...
    static void DemKyTu(String str) {
        ...
        for (int i = 0; i < MangKT.length; i++) {//vong lap mang ky tu ban dau
            int d = 0;//khoi tao bien dem bang 0
            for (int j = 0; j < charArray.length; j++) {//vong lap mang du lieu client
